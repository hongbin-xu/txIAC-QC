    ...
    with st.sidebar:
        ...
        with st.container():
            ...
            if merge_button&(st.session_state.path1 is not None)&(st.session_state.path2 is not None):
                ...
                st.session_state["suffixes"], st.session_state["data"], z = data_merge(data1 = st.session_state["data1"], data2 = st.session_state["data2"], qctype = qc_type,  item_list = item_list)
                st.write(z)
